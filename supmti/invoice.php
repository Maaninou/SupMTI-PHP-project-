	...
	<div class="typography">
			...
			<div class="container">
				<div class="typography-info">
					<h2 class="type">Reçu</h2>
				</div>
				<p>Informations de la résérvation</p>
...
{               ?>
                            <table border="1" class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                                            <tr>
    <th colspan="5" style="text-align: center;color: red;font-size: 20px">Numéro de réservation: <?php  echo $row->BookingNumber;?></th>
  </tr>
...
<table border="1" class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
  <tr>
    <th colspan="5" style="text-align: center;color: red;font-size: 20px">Details Reçu</th>
  </tr>
  <tr>
    <th style="text-align: center;">Nombre de jours</th>
  
   <th style="text-align: center;">Prix chambre</th>
