...
$query->bindParam(':bookingid',$bookingid,PDO::PARAM_STR);
 ...
 $query->execute();
  ...
  echo '<script>alert("Mis a jour avec succes")</script>';
...
{               ?>
                            <table border="1" class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                            	<tr>
  <th colspan="4" style="color: red;font-weight: bold;text-align: center;font-size: 20px"> Numero de la reservation: <?php echo $row->BookingNumber;?></th>
</tr>
<tr>
  <th colspan="4" style="color: blue;font-weight: bold;font-size: 15px"> Details de la reservation:</th>
</tr>
<tr>
    <th>Nom client</th>
  ...
  <tr>
   ...
   <tr>
    <tr>
  <th colspan="4" style="color: blue;font-weight: bold;font-size: 15px"> Details de la chambre</th>
</tr>
...
<tr>
   ...
   <tr>
  <th colspan="4" style="color: blue;font-weight: bold;font-size: 15px"> Remarques admins:</th>
</tr>
  <tr>
...
{
  echo "Reservation approuvee";
}

if($row->Status=="Cancelled")
{
 echo "Reservation annulee";
}
...
if($row->Status=="")
{
  echo "Pas de mis a jour";
     ...
     ;?></td>
     <th >Admin Remarques</th>
    <?php if($row->Status==""){ ?>

                     <td><?php echo "Pas de mise a jour"; ?></td>
...
<p align="center"  style="padding-top: 20px">                            
 <button class="btn btn-primary waves-effect waves-light w-lg" data-toggle="modal" data-target="#myModal">Action</button></p>  
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <th>Remarques :</th>
    <td>
    <textarea name="remark" placeholder="Remarques" rows="12" cols="14" class="form-control wd-450" required="true"></textarea></td>
  </tr> 
  ...
  <tr>
   ...
   <select name="status" class="form-control wd-450" required="true" >
     <option value="Approuvee" selected="true">Approuvee</option>
