...
echo '<script>alert("merci de verifier le mot de passe actuel")</script>';
...
{
alert('le nouveau mot de passe et la confirmation de mot de passe ne sont pas identiques');
							...
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								...
								<div class="form-body">
									...
									<form method="post" onsubmit="return checkpass();" name="changepassword">
									 ...
									 <div class="form-group"> <label for="exampleInputEmail1">Confirmation de mot passe</label> <input type="password" class="form-control"  name="confirmpassword" id="confirmpassword"  required='true'> </div>
