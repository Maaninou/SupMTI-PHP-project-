                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="content-top-1">
                                <h4 class="text-left text-uppercase" style="color: orange"><a href="new-booking.php"><b>Nouvelles reservations</b></a></h4>
...
?>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="margin-bottom:1px;">
                            <div class="content-top-1">
                                <h4 class="text-left text-uppercase" style="color: red"><a href="approved-booking.php"><b>reservations approuvees</b></a></h4>
...
?>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="content-top-1">
                                <h4 class="text-left text-uppercase" style="color: magenta"><a href="cancelled-booking.php"><b>reservations rejetees  </b></a></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                	<?php 
...
?>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="content-top-1">
                                <h4 class="text-left text-uppercase" style="color: orange"><a href="reg-users.php"><b>utilisateurs</b></a></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                	<?php 
...
?>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="margin-bottom:1px;">
                            <div class="content-top-1">
                                <h4 class="text-left text-uppercase" style="color: red"><a href="read-enquiry.php"><b>requetes lues</b></a></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                	<?php 
...
?>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="content-top-1">
                                <h4 class="text-left text-uppercase" style="color: magenta"><a href="unread-enquiry.php"><b>requetes non lues</b></a></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                	<?php 
