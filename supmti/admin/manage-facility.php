...
{               ?>
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell">
                                         ...
                                         <td class="d-none d-sm-table-cell"><a href="manage-facility.php?delid=<?php echo ($row->ID);?>" onclick="return confirm('Tu veux supprimer?');">Supprimer</a></td>
                                    </tr>
                                    <?php $cnt=$cnt+1;}} ?> 
