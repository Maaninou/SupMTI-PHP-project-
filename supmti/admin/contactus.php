...
$query->execute();
echo '<script>alert("Contactez nous a ete modifiee")</script>';
...
{               ?>
										...
										<div class="form-group"> <label for="exampleInputEmail1">Numero de telephone</label> <input type="text" name="mobnum" id="mobnum" required="true" value="<?php  echo $row->MobileNumber;?>" class="form-control"> </div>
