...
{               ?>
							<div class="room1">
								...
								<div class="col-md-7 room-grid1">
									...
									<p>Nombre d'adultes:<?php  echo htmlentities($row->MaxAdult);?></p>
									<p>Nombre d'enfants:<?php  echo htmlentities($row->MaxChild);?></p>
									<p>Nombre de lits:<?php  echo htmlentities($row->NoofBed);?></p>
									<p>Services:<?php  echo htmlentities($row->RoomFacility);?></p>
									<p>Prix: <?php  echo htmlentities($row->Price);?></p>
									<button class="btn btn-success"><a href="book-room.php?rmid=<?php echo $row->rmid;?>">Réserver</a></button>
								</div>
