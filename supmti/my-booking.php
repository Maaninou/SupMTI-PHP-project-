	...
	<div class="typography">
			...
			<div class="container">
				<div class="typography-info">
					<h2 class="type">Mes résérvations</h2>
				</div>
...
<?php } else { ?>                  <td><?php  echo htmlentities($row->Status);?>
                  ...
                  <?php } ?>
							 <td><a href="view-application-detail.php?viewid=<?php echo htmlentities ($row->bid);?>" class="btn btn-danger">Afficher</a>
                                                    </td>
							</tr>
							<?php $cnt=$cnt+1;}} ?>
