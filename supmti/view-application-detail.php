	...
	<div class="typography">
			...
			<div class="container">
				<div class="typography-info">
					<h2 class="type">Informations de la résérvation</h2>
				</div>
...
<tr>
  <th colspan="4" style="color: blue;font-weight: bold;font-size: 15px"> Informations de la résérvation:</th>
</tr>
<tr>
    <th>Nom</th>
...
{
  echo "Ta résérvation a été confirmée";
}

if($row->Status=="Cancelled")
{
 echo "Ta résérvation a été annulée";
}
...
<a href="invoice.php?invid=<?php echo htmlentities ($row->tid);?>" class="btn btn-success">Reçu</a>
				</div>
